...
class Controller:
    ...
    def update_user(self, id, username=None, password=None, role_id=None):
    ...
    def update_user_activity(self, id, user_id=None, activity_type=None, date_of_activity=None, time_of_activity=None):
    ...
    def update_patient(self, id, user_id=None, first_name=None, last_name=None, date_of_birth=None, gender=None, phone_number=None, email=None):
    ...
    def update_doctor(self, id, user_id=None, first_name=None, last_name=None, gender=None, specialization_id=None, department_id=None):
    ...
    def update_service(self, id, service_name=None, price=None, doctor_id=None):
    ...
    def update_appointment(self, id, slot_id=None, patient_id=None):
    ...
    def update_appointment_service(self, id, appointment_id=None, service_id=None):
    ...
    def update_diagnosis(self, id, diagnosis_name=None, diagnosis_code=None):
    ...
    def update_prescription(self, id, note=None, appointment_id=None):
    ...
    def update_patient_diagnosis(self, id, patient_id=None, diagnosis_id=None):
